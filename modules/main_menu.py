...
class App(ctk.CTk):
    ...
    def __init__(self, fg_color):
        ...
        self.button1 = CustomButton(self, text="", fg_color= "blue", hover = False, image = self.button1_image)
        self.button1.place(x= 530, y=670)

        self.button2_image= ctk.CTkImage(Image.open("modules\\images\\button2_bg.png"), size=(200, 50)) 
        self.button2 = CustomButton(self, text="",  fg_color= "transparent", hover = False, image = self.button2_image)
        self.button2.place(x= 770, y=670)

        self.button3_image= ctk.CTkImage(Image.open("modules\\images\\button3_bg.png"), size=(200, 50)) 
        self.button3 = CustomButton(self, text="",  fg_color= "transparent", hover = False, image = self.button3_image)
